...
<head>
    ...
    <title>@yield('title') Detail verified</title>
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        {{-- <h1>Nama : {{$verified->nama_anggota}}</h1>
                        <h1>NIP : {{$verified->nip}}</h1> --}}
                    </div>
                </div>
            </div>
        </div>
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->kode_pos }}</td>
                            <td>
                                <a href="/admin-sektor/dashboard/detail1/{{$data->NRK}}" class="btn btn-sm btn-primary">View</a></td>
                            </td>
                          </tr>
                        @endforeach --}}
                        <td>1</td>
                        ...
                        <td>Baik</td>
                        <td>foto2.jpg</td>
                        <td><a href="" class="btn btn-success btn-sm"><i class="fa fa-check"></i></a></a>
                        </td>
                    </tbody>
                  </table>
                        </div>
