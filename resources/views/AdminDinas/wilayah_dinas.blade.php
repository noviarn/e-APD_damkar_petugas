...
<head>
    ...
    <title>@yield('title') Wilayah</title>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                    <li>
                      ...
                      <a href="{{ url('/tambah-apd')}}"> <i class="menu-icon fa fa-group "></i>Tambah Apd </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">HALAMAN BAGIAN WILAYAH</strong>
                        </div>
                ...
                <table id="example1" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                           <tr>
                               <td>{{ $master_sektor->sektor }}</td>
                               <td>{{ $master_sektor->kode_wilayah }}</td>
                               <td>{{ $master_sektor->kode_sektor }}</td>
                               <td><a class="btn btn-primary" href="">Lihat</td>
                           </tr>
                </table>
                        </div>
                    </div>
