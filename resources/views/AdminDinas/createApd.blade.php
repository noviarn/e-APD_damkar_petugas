...
<head>
    ...
    <title>@yield('title')Tambah APD</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="{{ url('/dash-dinas')}}"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                        <a href="{{ url('')}}"> <i class="menu-icon fa fa-user "></i>Profile </a>
                        <a href="{{ url('/apd')}}"> <i class="menu-icon fa fa-plus "></i>Tambah APD </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                  ...
                  <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Tambah APD Baru</strong>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('simpan-apd') }}" method="post">
                                {{ csrf_field() }}
                                <div class="form-group row">
                                    <label class="col-md-4 text-md-right">Jenis APD</label>
                                    <div class="col-md-6">
                                        <input type="text" name="jenis_apd" class="form-control" required="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-4 text-md-right">Ukuran</label>
                                    <div class="col-md-6">
                                        <input type="text" name="ukuran" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-4 text-md-right">Foto</label>
                                    <div class="col-md-6">
