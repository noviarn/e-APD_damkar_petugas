...
<head>
    ...
    <title>@yield('title') Dashboard Admin Dinas</title>
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                    <li>
                      ...
                      <a href="{{ url('/profile-dinas')}}"> <i class="menu-icon fa fa-user "></i>Profile </a>
                      <a href="{{ url('/tambah-apd')}}"> <i class="menu-icon fa fa-plus "></i>Tambah APD </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">HALAMAN ADMIN DINAS</strong>
                        </div>
                        @if (session('pesan'))
                        ...
                        <table id="example1" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($master_wilayah as $data)
                                <tr>
                                    <td>{{ $data->wilayah }}</td>
                                    {{-- <td>{{ $data->kode_wilayah }}</td> --}}
                                    <td><a class="btn btn-primary" href="/dash-dinas/wilayah/{{ $data->kode_wilayah }}">Lihat</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
